...
export const handleSpeech = (req, res) => {
  ...
  if (!userSpeech) {
    ...
    twiml.say(
      "Got it — you need brake pads. What’s the make, model, and year of your vehicle?"
    );
    ...
    twiml.say(
      "I understand you need auto parts. To find the right one, please tell me your car’s make, model, and year."
    );
  }
